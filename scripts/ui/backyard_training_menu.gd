...
func _build_charged_guard_tab(tabs: TabContainer) -> void:
	...
	note.text = "Drive the hand strongly toward the pommel during the counter-swing to acquire Guard. Tune how long the folded pose must be maintained, the phase window, and how near-body position, recent movement, and continued pommel pull accelerate the charge. A deliberate authored flick releases the lock."
	...
	_create_contact_slider(box, "charged_guard_position_charge_enabled", "Charged Position State (0=Off, 1=On)", 0.0, 1.0, 1.0, "", _form_three_feel_tip("Separately enable the delayed blue charged-position layer without disabling the original Charged Guard acquisition and lock.", "Original Guard only: no delayed charge, blue glow, afterimages, or slow-reposition behavior.", "After the confirmation hold, enable the blue persistent state and slow reposition.", "Leave at 0 while tuning the original Guard. This switch does not disable Guard itself."))
