...
const CHARGED_GUARD_TUNING_KEYS: Array[String] = ["charged_guard_position_charge_enabled", "charged_guard_gestures_enabled", "charged_guard_hold_duration", "charged_guard_awaken_duration", "charged_guard_hold_limit", "charged_guard_break_speed", "charged_guard_acquisition_window", "charged_guard_pommel_alignment", "charged_guard_pommel_speed", "charged_guard_pommel_travel", "charged_guard_pommel_intent_time", "charged_guard_near_body_radius", "charged_guard_near_body_rate", "charged_guard_recent_motion_rate", "charged_guard_pommel_rate"]
...
static func built_in_contact_settings() -> Dictionary:
	return {
		"2": {"apex_hang_duration": 0.14, "apex_hang_time": 0.0, "charged_guard_enabled": 0.0, "charged_guard_position_charge_enabled": 0.0, "charged_guard_gestures_enabled": 0.0, "charged_guard_hold_duration": 0.20, "charged_guard_awaken_duration": 1.0, "charged_guard_hold_limit": 4.0, "charged_guard_break_speed": 600.0, "charged_guard_acquisition_window": 0.65, "charged_guard_pommel_alignment": 0.82, "charged_guard_pommel_speed": 90.0, "charged_guard_pommel_travel": 14.0, "charged_guard_pommel_intent_time": 0.06, "charged_guard_near_body_radius": 48.0, "charged_guard_near_body_rate": 0.0, "charged_guard_recent_motion_rate": 0.0, "charged_guard_pommel_rate": 0.0, "authored_metronome_enabled": 0.0, "authored_metronome_wake_speed": 350.0, "authored_metronome_energy_build": 0.8, "authored_metronome_energy_fade": 0.35, "authored_metronome_idle_grace": 2.0, "authored_metronome_sheathe_time": 1.0, "bite_duration": 0.0, "bite_target_drag": 0.0, "bite_velocity_transfer": 0.0, "blade_recoil_degrees": 5.0, "blade_recoil_return": 150.0, "clash_shake_duration": 0.1, "clash_shake_strength": 4.5, "clash_zoom": 0.01, "flesh_shake_strength": 0.0, "flesh_zoom": 0.005, "grip_authority_duration": 0.15, "grip_turn_speed_mult": 1.0, "parry_focus_duration": 0.1, "parry_shake_duration": 0.1, "parry_shake_strength": 2.0, "parry_zoom": 0.02, "parry_zoom_duration": 0.1, "rebound_flow_boost": 1.0}
	}
